...
var _WebsiteListings = require('./components/WebsiteListings.vue');

var _WebsiteListings2 = _interopRequireDefault(_WebsiteListings);

var _UserListings = require('./components/UserListings.vue');

var _UserListings2 = _interopRequireDefault(_UserListings);

var _ManagedUserListings = require('./components/ManagedUserListings.vue');

var _ManagedUserListings2 = _interopRequireDefault(_ManagedUserListings);

var _UserProfileEdit = require('./components/UserProfileEdit.vue');

var _UserProfileEdit2 = _interopRequireDefault(_UserProfileEdit);

var _SystemSettings = require('./components/SystemSettings.vue');

var _SystemSettings2 = _interopRequireDefault(_SystemSettings);

var _ManageWebsite = require('./components/ManageWebsite.vue');

var _ManageWebsite2 = _interopRequireDefault(_ManageWebsite);

var _TeamListings = require('./components/affiliates/TeamListings.vue');

var _TeamListings2 = _interopRequireDefault(_TeamListings);

var _Lobby = require('./components/chat/Lobby.vue');

var _Lobby2 = _interopRequireDefault(_Lobby);

var _Conversation = require('./components/chat/Conversation.vue');
...
var _website = require('./forms/website.vue');

var _website2 = _interopRequireDefault(_website);

var _users = require('./forms/users.vue');

var _users2 = _interopRequireDefault(_users);

var _affiliate = require('./forms/affiliate.vue');
...
var _MessageGraph = require('./components/dashboard/MessageGraph.vue');
...
var _FlaggedConversation = require('./components/FlaggedConversation.vue');

var _FlaggedConversation2 = _interopRequireDefault(_FlaggedConversation);
...
exports.default = {
	...
	components: {
		WebsiteListings: _WebsiteListings2.default,
		UserListings: _UserListings2.default,
		ManagedUserListings: _ManagedUserListings2.default,
		UserProfileEdit: _UserProfileEdit2.default,
		SystemSettings: _SystemSettings2.default,
		ManageWebsite: _ManageWebsite2.default,
		Conversation: _Conversation2.default,
		AffiliateTeamListings: _TeamListings2.default,

		ChatLobby: _Lobby2.default,

		WebsiteFormModal: _Modal2.default,
		UserFormModal: _Modal2.default,
		AffiliateFormModal: _Modal2.default,

		WebsiteForm: _website2.default,
		UserForm: _users2.default,
		AffiliateForm: _affiliate2.default,

		MessageGraph: _MessageGraph2.default,
		Account: _Account2.default,
		FlaggedConversation: _FlaggedConversation2.default
	},
	...
	events: {
		'user:created': function userCreated(user) {
			this.$broadcast('user:created', user);
		},
		'website:created': function websiteCreated(website) {
...
_vue2.default.filter('date', function (value) {
	...
	if (type == 'relative') {
		...
		return _moment2.default.unix(value).fromNow();
	}

	return (0, _moment2.default)(value).format(format || "MM/DD/YYYY");
});

_vue2.default.filter('str_limit', function (value, limit) {
	console.log(value);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-c8f078d8", module.exports)
  } else {
...
window.socket = io(_config2.default.host + ':' + _config2.default.port);
...
exports.default = {
	...
	methods: {
		getFlaggedConversations: function getFlaggedConversations() {
			var _this = this;

			this.$http.get('conversations/flagged').then(function (response) {
	...
	events: {
		...
		'conversation:unflagged': function conversationUnflagged(conversation) {
			this.getFlaggedConversations();
		}
	}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-55aed4be", module.exports)
  } else {
...
var _PhotoUpload = require('./../components/PhotoUpload.vue');
...
exports.default = {
	components: {
		EditWebsiteModal: _Modal2.default, WebsiteForm: _website2.default, PhotoUpload: _PhotoUpload2.default
	},
	...
	methods: {
		...
		changePhoto: function changePhoto() {
			this.$http.put('websites/' + this.website.id + '/change-photo', { logo: this.website.logo }).then(function (response) {
	...
	watch: {
		'website.logo': function websiteLogo() {
			var _this = this;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3b9a10cc", module.exports)
  } else {
...
var _website_user = require('./../stores/website_user');

var _website_user2 = _interopRequireDefault(_website_user);
...
var _managedUser = require('./../forms/managed-user.vue');
...
exports.default = {
	...
	ready: function ready() {
		...
		if (this.users) {
			(function () {
				...
				self.$http.get('websites/' + self.website.id + '/users').then(function (response) {
					self.paginator = response.data;
					self.users = self.paginator.data;
				});

				window.onscroll = function (ev) {
					var url = self.paginator.next_page_url;
	...
	methods: {
		unmanageUsers: function unmanageUsers() {
			var _this2 = this;
			...
			if (this.checkedUsers.length) {
				(0, _sweetalert2.default)({
					...
					_website_user2.default.delete({ website: _this2.website, users: _this2.checkedUsers }).then(function (response) {
						self.users = _underscore2.default.reject(self.users, function (user) {
							return _underscore2.default.contains(self.checkedUsers, user.id);
						});
						_this2.checkedUsers = [];
						toastr.success(response.data);
					});
		...
		updateManagedUser: function updateManagedUser(user) {
			this.$http.put('websites/' + this.website.id + '/managed-users/' + user.id, user).then(function (response) {
				toastr.success(response.data);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6cb7fe3d", module.exports)
  } else {
...
exports.default = {
	...
	events: {
		'modal:close': function modalClose(target) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-70751611", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6f5c0f77", module.exports)
  } else {
...
exports.default = {
	...
	methods: {
		saveSettings: function saveSettings() {
			_settings2.default.updateConfigs(this.configs).then(function (response) {
				toastr.success(response.data);
			});
		}
	},
	...
	watch: {
		'configs.auto_login_entire_site.value': function configsAuto_login_entire_siteValue(val) {
			var _this2 = this;

			this.$nextTick(function () {
				if (val == 1 || val == true) {
					_this2.configs.auto_login_fake_accounts.value = false;
				}
			});
		},
		'configs.auto_login_fake_accounts.value': function configsAuto_login_fake_accountsValue(val) {
			var _this3 = this;

			this.$nextTick(function () {
				if (val == 1 || val == true) {
					_this3.configs.auto_login_entire_site.value = false;
				}
			});
		}
	}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-814aa404", module.exports)
  } else {
	...
	methods: {
		...
		clearEarnings: function clearEarnings(user) {
			...
			(0, _sweetalert2.default)({
				...
				_this3.$http.post('users/' + user.id + '/clear-earnings').then(function (response) {
					user.earnings = 0;
					toastr.success(response.data);
				});
			});
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6d851ee6", module.exports)
  } else {
...
var _website = require('./../stores/website');
...
var _PhotoUpload = require('./PhotoUpload.vue');
...
exports.default = {
	...
	components: {
		...
		PhotoUpload: _PhotoUpload2.default
	...
	methods: {
		submit: function submit() {
			...
			_user2.default.update(this.user).then(function (response) {
		...
		checkWebsites: function checkWebsites(website) {
			var filtered = _underscore2.default.filter(this.user.managed_websites, function (val) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7f87aaac", module.exports)
  } else {
...
var _website3 = require('./../forms/website.vue');

var _website4 = _interopRequireDefault(_website3);
...
exports.default = {
	...
	components: {
		EditWebsiteModal: _Modal2.default, WebsiteForm: _website4.default
	},
	...
	methods: {
		edit: function edit(website) {
			this.website = website;
		},
		remove: function remove(website) {
			var _this = this;
			...
			(0, _sweetalert2.default)({
				...
				_website2.default.delete(website).then(function (response) {
					toastr.success(response.data);
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7aa8a964", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-02d18c79", module.exports)
  } else {
...
var _FlaggedConversationNotes = require('./../../forms/FlaggedConversationNotes.vue');

var _FlaggedConversationNotes2 = _interopRequireDefault(_FlaggedConversationNotes);
...
exports.default = {
	...
	components: {
		FlaggedConversationModal: _Modal2.default, FlaggedConversationNotes: _FlaggedConversationNotes2.default, PhotoUpload: _PhotoUpload2.default
	},
	...
	methods: {
		...
		sendAndNext: function sendAndNext() {
			...
			this.$http.post('chat/' + this.$parent.website.id + '/' + this.$parent.conversation.id, message).then(function (response) {
				...
				_this3.textContent = message.text;
				_this3.messages.$remove(message);
				toastr.error('Message not sent!');
			});
		},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-305a31e8", module.exports)
  } else {
...
var _ProfileBox = require('./ProfileBox.vue');

var _ProfileBox2 = _interopRequireDefault(_ProfileBox);

var _ChatBox = require('./ChatBox.vue');
...
exports.default = {
	...
	components: {
		ProfileBox: _ProfileBox2.default, ChatBox: _ChatBox2.default, Notes: _Notes2.default, ConversationFlaggedForm: _FlaggedConversationNotes2.default, UpdateConversationFlaggedModal: _Modal2.default
	},
	...
	ready: function ready() {
		...
		window.onbeforeunload = function (e) {
			self.$http.delete('chat/' + self.website.id + '/' + self.conversation.id + '/active-conversation').then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  module.hot.dispose(function () {
    __vueify_insert__.cache["/* line 10, stdin */\ntr.info td, tr.danger td, tr.warning td, tr.success td, tr.day td, tr.three-days td, tr.two-weeks td {\n  color: white !important;\n  font-weight: bolder !important; }\n\n/* line 16, stdin */\ntr.day td {\n  background-color: yellow; }\n\n/* line 21, stdin */\ntr.three-days td {\n  background-color: yellow; }\n\n/* line 26, stdin */\ntr.two-weeks td {\n  background-color: yellow; }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1963bc2b", module.exports)
  } else {
...
exports.default = {
	...
	methods: {
		submit: function submit() {
			...
			_note2.default.add(this.$parent.website, this.$parent.conversation, {
				note: this.noteText,
				type: this.filter
		...
		remove: function remove(note) {
			...
			(0, _sweetalert2.default)({
				...
				_note2.default.remove(note).then(function (response) {
					toastr.success(response.data);
					_this2.notes.$remove(note);
				}).catch(function (error) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-02327cd4", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-89127346", module.exports)
  } else {
		...
		showData: function showData(website) {
			...
			if (!this.fetching) {
				...
				this.$http.get('stats/' + website.id + '/messages').then(function (response) {
					...
					for (var i = 30; i > 1; i--) {
						dates.push((0, _moment2.default)().subtract(i, 'days'));
					}
					_this2.data = _underscore2.default.map(dates, function (date) {
						date = (0, _moment2.default)(date);
						var count = _underscore2.default.find(response.data, { date: date.format('MMM-DD-YYYY') });
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0ac0a8a4", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4d556fb5", module.exports)
  } else {
...
exports.default = {
    ...
    methods: {
        submit: function submit() {
            ...
            if (this.method == 'POST') {
                _conversation2.default.flag(this.form).then(function (response) {
                    _this.conversation.is_flagged = true;
                    _this.conversation.flagged = response.data;
                    _this.form.notes = '';
                ...
                _spin2.default.spin();
                _conversation2.default.updateFlag(this.form).then(function (response) {
                    _spin2.default.stop();
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-6c1295fe", module.exports)
  } else {
...
var _countries = require('./../stores/countries');
...
exports.default = {
	...
	components: {
		Photo: _PhotoUpload2.default, QrCode: _PhotoUpload2.default
	},
	...
	ready: function ready() {
		...
		this.countries = _countries2.default.all();
...
exports.default = {
	...
	methods: {
		searchUser: function searchUser() {
			...
			if (this.search) {
				_spin2.default.spin();
				this.$http.get('websites/' + this.website.id + '/users/' + this.search).then(function (response) {
					console.log(response.data);
					_this.paginator = response.data;
					_this.users = _this.paginator.data;
					_spin2.default.stop();
				}).catch(function (response) {
		...
		manageUser: function manageUser(user) {
			this.user = user;
		...
		submit: function submit() {
			...
			this.$http.post('websites/' + this.website.id + '/managed-users', {
				...
				_this2.showFakeMessageField = false;
				window.location.reload();
			}).catch(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-70615754", module.exports)
  } else {
...
exports.default = {
    ...
    components: {
        UserPhotoUpload: _PhotoUpload2.default
    },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-36a1298a", module.exports)
  } else {
...
exports.default = {
    ...
    components: {
        WebsitePhotoUpload: _PhotoUpload2.default
    },
    ...
    methods: {
        ...
        store: function store() {
            ...
            if (!this.saving) {
                this.saving = _spin2.default.spin();
                _website2.default.store(this.form).then(function (response) {
                    toastr.success('Website: ' + response.data.name + ' created!');
                    _this.$dispatch('website:created', response.data);
                    _this.form = {};
                    _this.errors = [];
                    _this.saving = _spin2.default.stop();
                }).catch(function (response) {
                    _this.saving = _spin2.default.stop();
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-54c0018e", module.exports)
  } else {
...
exports.default = {
	flag: function flag(form) {
		return _vue2.default.http.post('chat/' + form.website_id + '/flag-conversation', form);
	},
	unflag: function unflag(website_id, conversation_id) {
		return _vue2.default.http.delete('chat/' + website_id + '/' + conversation_id + '/unflag');
	},
	updateFlag: function updateFlag(form) {
		return _vue2.default.http.put('chat/' + form.website_id + '/flag-conversation/' + form.id, form);
	}
};
...
exports.default = {
	add: function add(website, conversation, data) {
		return _vue2.default.http.post('chat/' + website.id + '/' + conversation.id + '/notes', data);
	},
	update: function update(note) {
		return _vue2.default.http.put('notes/' + note.id, note);
	},
	remove: function remove(note) {
		return _vue2.default.http.delete('notes/' + note.id);
	}
};
...
exports.default = {
	getConfigs: function getConfigs() {
		return _vue2.default.http.get('settings');
	},
	updateConfigs: function updateConfigs(configs) {
		return _vue2.default.http.put('settings', configs);
	}
};
...
exports.default = {
	all: function all() {
		return _vue2.default.http.get('users');
	},
	store: function store(user) {
		return _vue2.default.http.post('users', user);
	},
	update: function update(user) {
		return _vue2.default.http.put('users/' + user.id, user);
	},
	delete: function _delete(users) {
		return _vue2.default.http.delete('users', users);
	}
};
...
exports.default = {
	all: function all() {
		return _vue2.default.http.get('websites');
	},
	store: function store(website) {
		return _vue2.default.http.post('websites', website);
	},
	update: function update(website) {
		return _vue2.default.http.put('websites/' + website.id, website);
	},
	delete: function _delete(website) {
		return _vue2.default.http.delete('websites/' + website.id);
	}
};
...
exports.default = {
	delete: function _delete(data) {
		return _vue2.default.http.delete('websites/' + data.website.id + '/unmanage-users', { users: data.users });
	}
};
